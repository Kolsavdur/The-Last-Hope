...
if kol_tlh_endingA_route == False:
    ...
    if kol_tlh_endingA_variation == False: #Stay in dragonland (base route with no TLD variation)
        ...
        $ renpy.pause (0.5)
        m "Logan went to a neraby stall and stood in line. With nothing else to do, I figured that I might as well wait with him."
        $ renpy.pause (0.5)
        m "We talkined about random nonsense as the line grew shorter and shorter. Eventually, our turn arrived."
        $ renpy.pause (1.0)
