...
Br "According to this statement, Reza was killed outside the underground facility on the night of the fireworks due to a bite wound from Maverick. Yet, in the official report, it was said that a feral dragon entered an unknown backdoor and killed Reza while [player_name], me, and the librarian working for the council were confronting him."
...
if kol_tlh_endingA_route == True:
    ...
    Lg "So yes, I’m sure."
    c "And what about the authorities? I don’t think they’d approve of you going back to upgrade the generator."
...
menu:
    ...
    "[[Answer the call.]":
        ...
        if kol_tlh_3B_played == True:
            $ renpy.pause (1.5)
            Ry "Remember how I daydreamed when Adine took Amely back to the orphanage at the end of our day at the beach? I just couldn't feel anything else but grief in that moment, knowing that I'll probably never get to experience the kind of bond that those two have for myself."
        ...
        if kol_tlh_remytherapycounter >= 3:
            $ kol_tlh_remytherapywin = True
...
#THE MINIMUM IS -8
#GET 3 TO PASS (unclear choices, maybe bring down depending on testing)
